...
import { QrCode, ExternalLink, AlertCircle, Clock, ShieldCheck, Loader2 } from 'lucide-react';
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl text-center">
          {status === 'unconfigured' && (
            <div>
              ...
              <p className="text-xs text-slate-500 mb-5 leading-relaxed">
                This CustomCliq QR code is authentic and registered, but has not yet been linked to a customer destination URL.
              </p>

              <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 text-left mb-5">
                <div className="flex justify-between items-center text-xs mb-1">
                  <span className="text-slate-500 font-medium">QR Short Code:</span>
              ...
              <p className="text-[11px] text-slate-400">
                Are you the owner of this QR? Log in to your Admin portal to configure your business link.
              </p>
            </div>
          )}
          ...
          {status === 'inactive' && (
            <div>
              ...
              <p className="text-xs text-slate-500 mb-5 leading-relaxed">
                This QR code has been temporarily set to inactive by the administrator.
              </p>
          ...
          {status === 'not_found' && (
            <div>
              ...
              <h2 className="text-lg font-bold text-black mb-1">Unrecognized QR Code</h2>
              <p className="text-xs text-slate-500 mb-5">
                This QR code ({code}) was not found in the CustomCliq system.
              </p>
            </div>
          )}
        </div>
